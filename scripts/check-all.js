...
const audioLibraryFiles = [
  "library.html", "library.css", "library.js", "assets/genesis-cover.webp",
  "api/hebrew-audio.js", "AUDIO_LIBRARY.md", "vercel.json",
...
for (const file of [...existingReaderFiles.filter((file) => file.endsWith(".js")), "library.js", "api/hebrew-audio.js", "scripts/generate-hebrew-audio.mjs"]) {
...
for (const forbidden of [/sk-[A-Za-z0-9_-]{20,}/, /sb_secret_[A-Za-z0-9_-]{20,}/]) {
  for (const file of ["library.js", "api/hebrew-audio.js", "library.html", "AUDIO_LIBRARY.md"]) {
